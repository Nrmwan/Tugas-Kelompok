...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="../assetsA/img/apple-icon.png">
  <link rel="icon" type="image/png" href="../assetsA/img/favicon.png">
...
<body class="">
      ...
      <div class="logo">
        <a href="https://www.creative-tim.com" class="simple-text logo-mini">
          <div class="logo-image-small">
            <img src="../assetsA/img/logo-small.png">
          </div>
          <!-- <p>CT</p> -->
        </a>
  ...
  <script src="../assetsA/js/plugins/bootstrap-notify.js"></script>
